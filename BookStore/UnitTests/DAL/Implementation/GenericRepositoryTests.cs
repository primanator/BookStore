...
//            var repository = new Repository<Book, BookDto> (contextFake);
...
//            var repository = new Repository<Book, BookDto>(contextStub);
...
//        {
//            var dbSetStub = Substitute.For<DbSet<BookDto>>();
//            var returnedValue = new BookDto();
//            dbSetStub.Find(Arg.Any<int>()).Returns(returnedValue);
//            var contextStub = Substitute.For<BookStoreContext>();
//            contextStub.Set<BookDto>().Returns(dbSetStub);
//            var repository = new Repository<Book, BookDto>(contextStub);
...
//            var repository = new Repository<Book, BookDto>(contextMock);

//            repository.Insert(new BookDto());
...
//            var contextStub = Substitute.For<BookStoreContext>();
//            contextStub.Set<Book>().Returns(dbSetStub);
//            var repository = new BookRepository<Book>(contextStub);
